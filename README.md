...
Everything the team needs from you lands in **one To-Do list** with **one plain daily summary** — so you act from a single place and never chase five separate agents. Three panels pin in your sidebar: a **Daily To-Do** (tap **✓ Apply / ✕ Not interested** on jobs, **✓ Accept / ✕ Reject** on CV upgrades), a **Daily Menu** (**▶ Run now** any helper early), and the **dashboard** — kept current by a daily refresh. Written in plain, everyday English throughout.
