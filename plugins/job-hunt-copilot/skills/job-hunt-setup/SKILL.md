...
1. **Your CV** — ask them to upload their current CV/resume (PDF/DOCX). This is the source of the Master Profile.
...
Confirm the final list with the user (add any board they named). Save it into the config (STEP 4).
...
- `data-searchlog.js` → `window.Q_SEARCHLOG = { date:"<today>", boards: [], note:"" };`
