...
Everything lands in **one pinned tile — the Dashboard** — with **one plain daily summary** from Coach, so you act from a single place instead of chasing five agents. The dashboard has **4 tabs**: **Today**, **Progress**, **My Profile**, **The Team**. The **Today tab is your Daily Hub**: at the top, a **▶ Run now** button for each helper to start it early; below that, today's jobs (**✓ Apply / ✕ Not interested**), pending CV upgrades (**✓ Accept / ✕ Reject** + Accept all) and any other asks. A tap never submits or logs in — it collects your choices into one line you copy and paste to me, and I do them. A small daily refresh keeps it current. Written in plain, everyday English throughout.
